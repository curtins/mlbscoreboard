...
var weekTotal="";
 ...
 function createURLDateParameters()

 {

	//Create file names of data and dates to be extracted from MLB
...
$.each(data.data.games.game, function() {	
	...
	// MLB Final Game Data Extraction
		...
		//if (this.status.status == 'Final' || this.status.status == 'Game Over' ||  this.status.status == 'Postponed' )  
			...
			ftrHTML+=" <li><table class='table' ><tr >";
			...
			ftrHTML+="<td><img src='../images/" + this.home_team_name + ".png'" + " width='40' height='40' alt='' /></td><td>&nbsp;&nbsp;(" + this.home_win + "-" + this.home_loss + ")</td>";
			...
			ftrHTML+="<td><img src='../images/" + this.away_team_name + ".png'" + " width='40' height='40' alt='' /></td><td>&nbsp;&nbsp;(" + this.away_win + "-" + this.away_loss + ")</td>";
